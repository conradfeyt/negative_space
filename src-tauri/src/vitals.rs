...
// ---------------------------------------------------------------------------
// Process dictionary — reuse from memory.rs but kept self-contained here
// so the module is independent. We could refactor to share later.
// ---------------------------------------------------------------------------
...
fn get_process_dictionary() -> HashMap<&'static str, (&'static str, &'static str)> {
    ...
    d.insert(
        "kernel_task",
        (
            "macOS kernel -- manages thermal throttling and hardware I/O",
            "system",
        ),
    );
    d.insert(
        "launchd",
        ("macOS init system -- manages all daemons", "system"),
    );
    d.insert(
        "WindowServer",
        ("Display compositor -- renders all windows", "system"),
    );
    d.insert("loginwindow", ("Login window manager", "system"));
    d.insert("Dock", ("Dock, Launchpad, Mission Control", "system"));
    d.insert("Finder", ("File manager and desktop", "app"));
    d.insert("NotificationCenter", ("Notification Center", "system"));
    d.insert("ControlCenter", ("Control Center quick settings", "system"));
    d.insert("SystemUIServer", ("Menu bar elements", "system"));

    // Spotlight
    d.insert("mds", ("Spotlight metadata server", "system"));
    d.insert("mds_stores", ("Spotlight index data store", "system"));
    d.insert("mdworker", ("Spotlight indexing worker", "system"));
    d.insert(
        "mdworker_shared",
        ("Spotlight shared indexing worker", "system"),
    );
    d.insert("corespotlightd", ("Core Spotlight daemon", "system"));

    // Networking
    d.insert("mDNSResponder", ("DNS resolver and Bonjour", "system"));
    d.insert("networkd", ("Network configuration", "system"));
    d.insert("WiFiAgent", ("Wi-Fi management", "system"));
    d.insert("airportd", ("Wi-Fi hardware management", "system"));
    d.insert("rapportd", ("AirDrop and Handoff", "system"));
    d.insert("sharingd", ("AirDrop, Handoff, Shared Clipboard", "system"));

    // Security
    d.insert(
        "securityd",
        ("Keychain and certificate management", "system"),
    );
    d.insert("trustd", ("Certificate trust evaluation", "system"));
    d.insert("XprotectService", ("Apple malware scanner", "system"));

    // iCloud
    d.insert("cloudd", ("iCloud sync daemon", "system"));
    d.insert("bird", ("iCloud Drive file sync", "system"));
    d.insert(
        "nsurlsessiond",
        ("Background network transfers (iCloud)", "system"),
    );
    d.insert("cloudphotod", ("iCloud Photos sync", "system"));

    // Storage
    d.insert("fseventsd", ("File system events", "system"));
    d.insert("backupd", ("Time Machine backup", "system"));

    // Audio / Display
    d.insert("coreaudiod", ("Core Audio daemon", "system"));
    d.insert(
        "corebrightnessd",
        ("Display brightness (True Tone, Night Shift)", "system"),
    );

    // Developer
    d.insert("node", ("Node.js runtime", "developer"));
    d.insert("ruby", ("Ruby interpreter", "developer"));
    d.insert("python3", ("Python 3 interpreter", "developer"));
    d.insert("python", ("Python interpreter", "developer"));
    d.insert("cargo", ("Rust package manager", "developer"));
    d.insert("rustc", ("Rust compiler", "developer"));
    d.insert("rust-analyzer", ("Rust language server", "developer"));
    d.insert("swift-frontend", ("Swift compiler", "developer"));
    d.insert("clang", ("C/C++/ObjC compiler", "developer"));

    // Browsers / Electron helpers
    d.insert(
        "Google Chrome Helper",
        ("Chrome tab/extension renderer", "app"),
    );
    d.insert("Google Chrome Helper (GPU)", ("Chrome GPU process", "app"));
    d.insert(
        "Google Chrome Helper (Renderer)",
        ("Chrome page renderer", "app"),
    );
    d.insert(
        "com.apple.WebKit.WebContent",
        ("Safari/WebKit page renderer", "app"),
    );
    d.insert(
        "com.apple.WebKit.Networking",
        ("Safari/WebKit network handler", "app"),
    );
    d.insert("com.apple.WebKit.GPU", ("Safari/WebKit GPU process", "app"));

    // Common apps
    d.insert("Safari", ("Safari web browser", "app"));
    d.insert("Mail", ("Apple Mail", "app"));
    d.insert("Messages", ("iMessage", "app"));
    d.insert("Music", ("Apple Music", "app"));
    d.insert("Photos", ("Apple Photos", "app"));
    d.insert("Slack", ("Slack messaging", "app"));
    d.insert("Spotify", ("Spotify music", "app"));
    d.insert("Discord", ("Discord chat", "app"));
    d.insert("Notion", ("Notion workspace", "app"));
    d.insert("zoom.us", ("Zoom video conferencing", "app"));
    d.insert("1Password", ("1Password password manager", "app"));

    // System daemons we can safely describe
    d.insert("cfprefsd", ("Preferences daemon", "system"));
    d.insert("lsd", ("Launch Services (file associations)", "system"));
    d.insert("coreservicesd", ("Core Services (app launch)", "system"));
    d.insert(
        "dasd",
        ("Duet Activity Scheduler (battery optimization)", "system"),
    );
    d.insert("thermalmonitord", ("Thermal monitoring daemon", "system"));
    d.insert("powerd", ("Power management daemon", "system"));
    d.insert("logd", ("Unified logging daemon", "system"));
    d.insert("diagnosticd", ("Diagnostics and crash reports", "system"));
    d.insert("ReportCrash", ("Crash reporter", "system"));
    d.insert("spindump", ("Hang reporter", "system"));
    d.insert("runningboardd", ("Process lifecycle management", "system"));
    d.insert("distnoted", ("Distributed notification center", "system"));

    d
}

/// App bundle path -> group name mappings (same approach as memory.rs).
fn get_app_bundle_mappings() -> Vec<(&'static str, &'static str, &'static str)> {
    vec![
        ...
        ("Microsoft Teams", "Microsoft Teams", "Team collaboration"),
        ...
        ("IntelliJ", "IntelliJ IDEA", "Java IDE by JetBrains"),
        ("PyCharm", "PyCharm", "Python IDE by JetBrains"),
        ("WebStorm", "WebStorm", "JS IDE by JetBrains"),
